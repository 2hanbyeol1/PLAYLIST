...
<body style="overflow: hidden;">
    ...
    <section class="form-section" id="shopping-section">
        <!-- DB LOGIN -->
        <form action = "../loginAction.jsp" class="userInfo-form" method="post">
            <h2>로그인</h2>
            ...
            <div class="userInfo-form-content">
                <input class="userInfo-form-button" type="submit" value="로그인" onclick="inputCheck(event);">
            </div>
            <div class="userInfo-form-content">
                <a href="signup.jsp">회원가입 화면으로</a>
            </div>
		</form>
    </section>
</body>
